...
function logger (msg) {
    ...
    console.log("logger this:", this);
}
igReq = utils.wrapFunction(logger, null, ["weeee"]);
igRequestsDispatcher.schedule(igReq);*/
...
module.exports = {
    getTagMediaCount: function (tagName, callback) {
        ...
        Instagram.tags.info(optionsObject);
    },
    getRecentImagesUrl: function (tagName, min_tag_id, callback) {
        ...
        Instagram.tags.recent(optionsObject);
    },
    subscribeTag: function (tagName, callback) {
        ...
        Instagram.tags.subscribe (optionsObject);
    },
