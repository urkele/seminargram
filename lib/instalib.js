...
var igRequestInterval = 1 * 60 * 60 * 1000 // hours * mins * secs * ms
...
for (var i = 1; i <= 9; i++) {
    igRequestsDispatcher.schedule(logger, "weeee_"+i);
};
*/
...
module.exports = {
    getTagMediaCount: function (tagName, callback) {
        ...
        igRequestsDispatcher.schedule(Instagram.tags.info, optionsObject);
    },
    getRecentImagesUrl: function (tagName, min_tag_id, callback) {
        ...
        igRequestsDispatcher.schedule(Instagram.tags.recent, optionsObject);
    },
    subscribeTag: function (tagName, callback) {
        ...
        igRequestsDispatcher.schedule(Instagram.tags.subscribe, optionsObject);
    },
