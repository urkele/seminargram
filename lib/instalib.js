...
module.exports = {
    ...
    unsubscribeTag: function (subscriptionId, callback) {
        console.log("@instalib.unsubscribeTag - unsubscribing id:", subscriptionId);
        var optionsObject = {
            id: subscriptionId,
            error: function (errorMessage, errorObject, caller) {
                console.log ("@instalib.unsubscribeTag - unsubscribeTag id '%s' returned an error", subscriptionId, errorMessage, errorObject);
                callback(errorMessage);
            },
            complete: function (data) {
                callback(null, data);
        ...
        Instagram.tags.unsubscribe(optionsObject);
    },
